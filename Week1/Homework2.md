...
Terraform will perform the following actions:
  ...
  + resource "google_storage_bucket" "data-lake-bucket" {
      ...
      + id                          = (known after apply)
      + location                    = "AUSTRALIA-SOUTHEAST2"
      + name                        = "dtc_data_lake_amplified-cat-375604"
...
╵
╷
│ Error: Error creating Dataset: googleapi: Error 409: Already Exists: Dataset amplified-cat-375604:trips_data_all, duplicate
│
